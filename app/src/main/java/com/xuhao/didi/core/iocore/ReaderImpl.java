...
public class ReaderImpl extends AbsReader {
    ...
    public void read() throws RuntimeException {
        ...
        if (headerProtocol instanceof CustomIReaderProtocol) {
    ...
    private void defaultRead(OriginalData originalData, IReaderProtocol headerProtocol) {
    ...
    private void customIWRead(OriginalData originalData) {
        ...
        if (SLog.isDebug() && byteBuffer != null) {
